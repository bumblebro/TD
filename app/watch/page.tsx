...
export default function WatchPage() {
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "VideoObject",
      name: data.file_name,
      description: `Watch ${data.file_name} from TeraBox without login`,
      thumbnailUrl: data.thumb,
      contentUrl: data.direct_link,
      uploadDate: new Date().toISOString(),
      duration: "PT0H0M0S", // This would ideally be the actual video duration
      potentialAction: {
        "@type": "WatchAction",
  ...
  return (
    <>
      <Head>
        <title>
          {data
            ? `${data.file_name} - TeraBox Stream`
            : "TeraBox Stream - Watch & Download TeraBox Videos Online"}
        </title>
        <meta
          name="description"
          content={
            data
              ? `Watch ${data.file_name} from TeraBox without login. Fast, free, and secure video streaming.`
              : "Stream and download videos from TeraBox without login. Fast, free, and secure video streaming service."
          }
        />
        <meta
          name="keywords"
          content="terabox video, terabox stream, terabox download, watch terabox videos, terabox video player, terabox online player, terabox video streaming, terabox video downloader"
        />
        ...
        <meta property="og:image" content={data?.thumb || "/og-image.jpg"} />
        <meta
          property="og:url"
        ...
        />
        <meta name="twitter:image" content={data?.thumb || "/og-image.jpg"} />

        {/* Additional SEO Tags */}
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="author" content="TeraBox Stream" />
        <meta name="application-name" content="TeraBox Stream" />
