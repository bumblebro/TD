              ...
              <div className="max-w-3xl mx-auto ">
                <div className="p-4 bg-gray-50 rounded-xl sm:p-8">
                  ...
                  >
                    <div>
                      ...
                      <div className="flex flex-col gap-2 sm:flex-row">
                        <input
                          type="url"
                          id="url"
                          name="token" // 👈 query param name stays consistent with /watch
                          value={url}
                          onChange={(e) => setUrl(e.target.value)}
                          placeholder="https://1024terabox.com/s/..."
                          required
                    ...
                    {loading && (
                      <div className="p-4 text-sm text-blue-800 bg-blue-100 border border-blue-300 rounded-lg">
                        {loadingMessage}
                      </div>
                    )}
                    ...
                    <button
                      type="submit"
                      disabled={!isValidUrl(url) || !checkUrlPatterns(url)}
                      className={`w-full px-4 py-2 text-sm font-medium text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                        isValidUrl(url) && checkUrlPatterns(url)
